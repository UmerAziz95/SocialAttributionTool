"""Ingestion service for TikTok ads frequency files."""
...
class TikTokByAdsFreqIngestionService(PlatformFileIngestionService):
    def __init__(self) -> None:
        super().__init__(TikTokByAdsFreqRepository())


__all__ = ["TikTokByAdsFreqIngestionService"]
