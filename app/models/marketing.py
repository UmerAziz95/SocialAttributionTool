...
class StgShopifyDailyCity(Base):            
    ...
    total_sales: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    net_sales: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    duties: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    taxes: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    returning_customers: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    new_customers: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    orders_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    gross_sales_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    total_sales_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    net_sales_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    duties_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    taxes_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    returning_customers_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    new_customers_previous_month: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    checkout_sessions: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    online_store_visitors: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
    ...
    sessions: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 4), server_default=text("0"))
